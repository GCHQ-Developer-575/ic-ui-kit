...
| `showGoToPageControl`     | `show-go-to-page-control`     | Whether the 'go to page' control should be displayed.                                                                                                               | `boolean`                              | `false`     |
| `showItemsPerPage`        | `show-items-per-page`         | Whether the number of total items and current item range or number of total pages and current page should be displayed.                                             | `boolean`                              | `true`      |
| `showItemsPerPageControl` | `show-items-per-page-control` | Whether the select input to control 'items per page' should be displayed.                                                                                           | `boolean`                              | `false`     |
